...
namespace maxbl4.Race.Logic.RoundTiming
{
    public class RoundPosition
    {
        ...
        public static IComparer<RoundPosition> LapsCountFinishedComparer { get; } =
            new LapsCountFinishedRelationalComparer();
            ...
            IEnumerable<Lap> laps = null)
        {
            ...
            Duration = End - Start;
            Finished = finished;
            StartSequence = Laps.FirstOrDefault()?.Checkpoint.Id ?? Guid.Empty;
            EndSequence = Laps.LastOrDefault()?.Checkpoint.Id ?? Guid.Empty;
            return this;
        }
