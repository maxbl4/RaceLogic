...
namespace maxbl4.Race.Logic.LogManagement
{
    public class SessionLog
    {
        ...
        public IFinishCriteria FinishCriteria { get; private set; }
        ...
        private void ApplyStart(SessionStart start)
        {
        ...
        private ITrackOfCheckpoints ReloadTrack(DateTime startTime, IFinishCriteria finishCriteria)
        {
            ...
            where T : IHasId<T>
        {
            ...
            foreach (var insert in inserts) yield return insert;
        }
    }
}