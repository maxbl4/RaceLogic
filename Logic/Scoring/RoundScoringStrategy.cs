...
namespace maxbl4.Race.Logic.Scoring
{
    public class RoundScoringStrategy
    {
        ...
        public static RoundScoringStrategy FromFirstPlacePoints(int firstPlacePoints, int substractBy = 1,
            IEnumerable<int> bonusScores = null,
            bool rateDnfs = false)
        {
        ...
        public IEnumerable<RoundScore> Calculate(IEnumerable<RoundPosition> positions,
            IEnumerable<string> expectedRiders = null)
        {
